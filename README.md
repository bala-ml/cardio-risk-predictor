...
A FastAPI-based backend is included for future extension.  
The current deployment uses a single integrated Streamlit application, so the API is not required to run the app.
